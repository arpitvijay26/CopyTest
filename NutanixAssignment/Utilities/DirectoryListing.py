...
class DirectoryListing:
    ...
    @staticmethod
    def get_full_path(source, value, os):
        """
        ...
        :param os: String -> Operating System for which full path is required
        :return: String -> Absolute Path of the value Directory/File wrt to source
        """
        sep = FileSeparator.file_separator_pattern(os)
        file_separator = sep.file_separator()
        return source + file_separator + value

    @staticmethod
    def listdir_fullpath(source, os):
        """
        ...
        """
        return [DirectoryListing.get_full_path(source, file_folder, os) for file_folder in listdir(source)]

    @staticmethod
    def list_all_files_and_directories_recursive_full_path(source, os):
        """
        ...
        :param os: String -> Operating System for which recursive listing is required
        :return: List -> List of Files and Folders with there absolute path
        """
        list_of_files_folders = []
        try:
            if not isfile(source):
                list_of_files_folders = DirectoryListing.listdir_fullpath(source, os)
                try:
    ...
    @staticmethod
    def list_all_files_and_directories_recursive_relative_path(source, os):
        """
        ...
        list_with_abs_path = DirectoryListing.list_all_files_and_directories_recursive_full_path(source, os)
...
if __name__ == '__main__':
    ...
    print(DirectoryListing.list_all_files_and_directories_recursive_full_path
          ("/Users/arpit/Documents/Mac/Automation/cwa-mac-automation/WorkspaceAutomation/Webservice", "posix"))
    print(DirectoryListing.list_all_files_and_directories_recursive_relative_path
          ("/Users/arpit/Documents/Mac/Automation/cwa-mac-automation/WorkspaceAutomation/Webservice", "posix"))
