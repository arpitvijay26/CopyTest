...
from NutanixAssignment.Utilities.CommonHelper import listdir, isfile
...
class DirectoryListing:
    ...
    def listdir_fullpath(source):
        ...
        :param path: Path of Directory for which list of Files/Directories is required
            ...
            try:
                for listed_path in list_of_files_folders:
                    if not isfile(listed_path):
                        list_of_files_folders.extend(DirectoryListing.list_all_files_and_directories_recursive_full_path(listed_path))
